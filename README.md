...
- SMS/e-posta bildirim sistemi tamamen kaldırıldı.
- Başvuru yapıldığında sadece sistem içinde başvuru kaydı oluşur.
- Telefonlara SMS gitmez.
- E-posta gönderimi yapılmaz.
- GitHub / Railway / Render yayını için hazır final sürümdür.
