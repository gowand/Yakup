    ...
    <main class="container grid2">
      <section class="card">
        ...
        <form method="POST" action="/library-apply">
          ...
          <textarea name="aboutEN" placeholder="About Us (EN)"></textarea>
    ...
    <div class="admin">
      ...
      <main class="workspace">
        ...
        <form class="card" method="POST" enctype="multipart/form-data">
          ...
          <textarea name="aboutEN" placeholder="About Us (EN)">${library.aboutEN || ""}</textarea>
      ...
      <main class="workspace">
        ...
        <form class="card" method="POST" enctype="multipart/form-data">
          <div class="form-grid">
            ...
            <input name="titleEN" placeholder="Event title (EN)" required>
          </div>
          <textarea name="descriptionTR" placeholder="Etkinlik açıklaması (TR)" required></textarea>
          <textarea name="descriptionEN" placeholder="Event description (EN)" required></textarea>
          <div class="form-grid">
            <input type="date" name="date" required>
            <input name="time" placeholder="${text(req, "Saat", "Time")}">
            <input name="locationTR" placeholder="Yer (TR)">
            <input name="locationEN" placeholder="Location (EN)">
    ...
    <div class="admin">
      ...
      <main class="workspace">
        ...
        <form class="card" method="POST" enctype="multipart/form-data">
          ...
          <textarea name="descriptionEN" placeholder="Game description (EN)"></textarea>
          <textarea name="howToPlayTR" placeholder="Nasıl oynanır? (TR)"></textarea>
          <textarea name="howToPlayEN" placeholder="How to play? (EN)"></textarea>
...
app.post("/dashboard/games", requireRole("LIBRARY_ADMIN"), uploader("games").single("image"), (req, res) => {
  ...
  db.games.push({
    ...
    howToPlayEN: req.body.howToPlayEN,
